     ...
     return (
       <form className="form-inline " onSubmit={handleSubmit(this.handleSubmit)}>
         <div className="form-group mx-3 w-100">
           <Field placeholder="New channel" name="text" required className="form-control rounded-0 border-top-0 border-left-0 border-right-0" component="input" type="text" autoComplete="off" />
         </div>
       </form>
     );
   }
